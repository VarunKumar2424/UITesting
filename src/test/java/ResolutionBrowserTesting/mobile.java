...
public void ChromeDriver1() throws IOException {
    ...
    driver.manage().window().maximize();
     ...
     TakesScreenshot TS=(TakesScreenshot)driver;
		...
		FileUtils.copyFile(Chromebrowser1,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\414,896\\"+timetamp11()+"mobilelink1.png"));
   }  
...
FileUtils.copyFile(Edgebrowser1,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\414,896\\"+timetamp2()+"mobilelink1.png"));
}  
...
public void ChromeDriver2() throws IOException {
    ...
    driver.manage().window().maximize();
     ...
     TakesScreenshot TS=(TakesScreenshot)driver;
		...
		FileUtils.copyFile(Chromebrowser2,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\375,667\\"+timetamp3()+"mobilelink1.png"));
   }  
...
FileUtils.copyFile(Edgebrowser2,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\375,667\\"+timetamp4()+"mobilelink1.png"));
}  
