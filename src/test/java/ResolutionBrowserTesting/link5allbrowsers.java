	    ...
	    public void ChromeDriver() throws IOException {
		  ...
		  driver.manage().window().maximize();
		   driver.get("https://www.getcalley.com/how-calley-auto-dialer-app-works/"); 
			...
			FileUtils.copyFile(Chromebrowser,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\1920,1080\\"+timetamp()+"Screenshots5.png"));
	...
	@Test(priority=2)
	   ...
	   driver.get("https://www.getcalley.com/how-calley-auto-dialer-app-works/"); 
		   ...
		   TakesScreenshot TS=(TakesScreenshot)driver;
			...
			FileUtils.copyFile(Edgebrowser,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\1920,1080\\"+timetamp1()+"Screenshots5.png"));
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			driver.quit();
		   }  
	   ...
	   */
		    ...
		    public void ChromeDriver2() throws IOException {
			  ...
			  driver.manage().window().maximize();
			   driver.get("https://www.getcalley.com/how-calley-auto-dialer-app-works/"); 
				...
				FileUtils.copyFile(Chromebrowser2,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\1366,768\\"+timetamp2()+"Screenshots5.png"));
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				driver.quit();
				}  
		...
		@Test(priority=5)
		   ...
		   driver.get("https://www.getcalley.com/how-calley-auto-dialer-app-works/"); 
			   ...
			   TakesScreenshot TS=(TakesScreenshot)driver;
				...
				FileUtils.copyFile(Edgebrowser3,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\1366,768\\"+timetamp3()+"Screenshots5.png"));
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				driver.quit();
				}  
			...
			FileUtils.copyFile(Chromebrowser31,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\1536,864\\"+timetamp4()+"Screenshots5.png"));
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			driver.quit();
			}  
		...
		@Test(priority=7)
           ...
           TakesScreenshot TS=(TakesScreenshot)driver;
			...
			FileUtils.copyFile(Edgebrowser5,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\1536,864\\"+timetamp5()+"Screenshots5.png"));
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			driver.quit();
			}  
