	...
	@Test(priority=1)
		    public void ChromeDriver() throws IOException {
		        ...
		        driver.manage().window().maximize();
		         ...
		         TakesScreenshot TS=(TakesScreenshot)driver;
					...
					FileUtils.copyFile(Chromebrowser,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\360,640\\"+timetamp()+"Screenshots5.png"));
			   }  
     ...
     public void EdgeTest() throws IOException {
         ...
         TakesScreenshot TS=(TakesScreenshot)driver;
			...
			FileUtils.copyFile(Edgebrowser,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\360,640\\"+timetamp1()+"Screenshots5.png"));
	   }  
...
public void ChromeDriver1() throws IOException {
    ...
    driver.manage().window().maximize();
     ...
     TakesScreenshot TS=(TakesScreenshot)driver;
		...
		FileUtils.copyFile(Chromebrowser1,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\414,896\\"+timetamp11()+"Screenshots5.png"));
   }  
...
FileUtils.copyFile(Edgebrowser1,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\414,896\\"+timetamp2()+"Screenshots5.png"));
}  
...
public void ChromeDriver2() throws IOException {
    ...
    driver.manage().window().maximize();
     ...
     TakesScreenshot TS=(TakesScreenshot)driver;
		...
		FileUtils.copyFile(Chromebrowser2,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\ChromeBrowser\\375,667\\"+timetamp3()+"Screenshots5.png"));
   }  
...
FileUtils.copyFile(Edgebrowser2,new File("C:\\Users\\Varun Kumar\\eclipse-workspace\\UITesting\\EdgeBrowser\\375,667\\"+timetamp4()+"Screenshots5.png"));
}  
